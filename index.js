...
/**
 * Get exact value of incoming variable/element/instance/function etc.
 * @stability 1 !Warning use this method.
 * 
 * Method will calculate the value and will return 
 * him in withc type you want.
 * 
 * @param {Boolean, String, Number, Function, Object} _variable
 * @param {String|false|'unchange'} result_type Use false to skip this step
 * @param {Array} args If variable is a function, will pe passed as func arguments.
 *
 * @return {String|Boolean|Number|*}
 */
exports.valueOf = (_variable, result_type = 'unchange', ...args) =>
{
    let _value = '';
